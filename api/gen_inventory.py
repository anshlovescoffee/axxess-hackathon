...
inventory = pd.DataFrame({
    "item": [
        "wheelchair", "bandages", "viagra", "syringes", "insulin", "antibiotics", "scalpel", "crutches", "ibuprofen", "gauze",
